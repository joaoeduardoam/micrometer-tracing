package com.joaoeduardo.micrometertracing.controller;

import com.joaoeduardo.micrometertracing.model.CustomerEntity;
import com.joaoeduardo.micrometertracing.service.CustomerService;
...
public class CustomerController {
    ...
    public ResponseEntity<Object> entityNotFoundException(Exception e) {
        var map = new HashMap<String, String>();
        map.put("message", "Customer Not Found");
        log.warn("method=entityNotFoundException, step=not_found, e={}", e.getMessage());
        return ResponseEntity
                .status(HttpStatus.NOT_FOUND)
                .body(map);
    }
